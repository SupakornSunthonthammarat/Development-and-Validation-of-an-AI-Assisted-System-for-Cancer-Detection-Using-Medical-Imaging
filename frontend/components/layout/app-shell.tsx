...
import { Activity, BarChart3, ChevronRight, MessageSquare, SearchCheck, Settings, UploadCloud } from "lucide-react";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="app-gradient min-h-screen">
      ...
      <div className="sticky top-0 z-20 border-b border-border/70 bg-white/84 px-4 py-3 backdrop-blur-2xl dark:bg-slate-950/84 lg:hidden">
